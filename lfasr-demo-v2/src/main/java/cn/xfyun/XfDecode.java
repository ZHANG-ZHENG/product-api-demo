...
public class XfDecode {
	
	
	
	public static void main(String[] args) {
		File file = new File("C:\\Users\\Administrator\\Desktop\\ffmpeg6_mp4_wav\\input\\testbvn.txt");
		...
		try {
			File fileSrt = new File("C:\\Users\\Administrator\\Desktop\\ffmpeg6_mp4_wav\\input\\testbvn.srt");
